  ...
  <script type="text/javascript">
    var handleChange = function() {
      ...
      if (selectedHeadset === "Insight") {
        var sensors = [...InsightSensorList];
        if (selectList.children.length == EpocSensorList.length) {
          while (selectList.firstChild) {
            selectList.removeChild(selectList.firstChild);
          }
        }
      } else {
        var sensors = [...EpocSensorList];
        if (selectList.children.length == InsightSensorList.length) {
          while (selectList.firstChild) {
            selectList.removeChild(selectList.firstChild);
          }
        }
